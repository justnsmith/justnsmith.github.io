...
const tech = [
  ...
  { name: "Tailwind CSS", icon: SiTailwindcss, color: "#38bdf8", proficiency: 95 },
  { name: "Git", icon: SiGit, color: "#f1502f", proficiency: 85 },
  { name: "PostgreSQL", icon: SiPostgresql, color: "#336791", proficiency: 80 },
  { name: "Node.js", icon: SiNodedotjs, color: "#83cd29", proficiency: 85 },
];
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-8 text-white">
          {tech.map(({ name, icon: Icon, color, image, proficiency }, index) => {
            ...
            return (
              <div
                key={name}
                className={`flex flex-col items-center space-y-3 transform transition-all duration-500 ${
                  isInView
              ...
              >
                <div
                  className={`relative w-20 h-20 rounded-xl flex items-center justify-center transition-all duration-500 ${
                    isActive || isHovered
                ...
                <div className="relative">
                  ...
                  <div
                    className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r transition-all duration-500 ease-out ${
                ...
                <div
                  className={`w-full h-1.5 bg-gray-800 rounded-full overflow-hidden transition-all duration-300 ${
